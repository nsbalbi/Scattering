...
# Collect Data
theta, i1, i2, _, _ \
    = mie_scattering(n_p, n_s, a_p, lambda_vac, phi)  # Mie scattering
_, i1r, i2r, _, _ \
    = rayleigh_scattering(n_p, n_s, a_p, lambda_vac, phi)  # Rayleigh scattering
# duplicate and flip data to include 180 to 360 degrees
...
plt.savefig('Results\intensity_plot.png', dpi=400, bbox_inches="tight")
plt.show()
